...
function Navbar(): JSX.Element {
    ...
    return (
        <Box _light={{bg: 'white'}} _dark={{bg: 'black'}} className='!border !border-l-0 !border-r-0 !border-t-0 !border-bottom-slate-300 !mb-5 w-full fixed top-0 left-0 '>
            <Box className='wrapper mx-auto flex justify-between items-center p-5 !py-2 '>
                ...
                {/* for links */}
                <Box className='flex gap-16 !text-lg !font-semibold' display={{ base: 'none', md: 'flex' }}>
                    <Link href={'/about'} className='relative overflow-hidden navLink'>
                        <span className='bottomSlice'></span>
                        Biz haqimizda
                    </Link>
                    <Link href={'#'} className='relative overflow-hidden navLink'>
                        <span className='bottomSlice'></span>
                        Loyihalar
                    </Link>
                    <Link href={'#'} className='relative overflow-hidden navLink'>
                ...
                {/* for responsive menu */}
                <Box display={{ base: 'flex', md: 'none' }} alignContent={'center'}>
                    <Drawer.Root >
                        ...
                        <Portal>
                            ...
                            <Drawer.Positioner>
                                <Drawer.Content>
                                    <Drawer.Header borderBottom="2px solid #eef1f6" >
                                    ...
                                    <Drawer.Body>
                                        ...
                                        <Box className='grid gap-3'>
                                            ...
                                            <Button variant={'outline'} color={'white'} bg={'#333333'} _hover={{ bg: 'black' }} className='orderBtn'>Buyurtma berish</Button>
                                        </Box>
                                    </Drawer.Body>
